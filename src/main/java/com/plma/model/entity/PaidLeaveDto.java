...
public class PaidLeaveDto {
	...
	public PaidLeaveDto(Integer id, String code, Date join_date, String hurigana_lastname, String hurigana_firstname,
			String lastname, String firstname, String department_name, Integer working_days, Date reference_date,
			Integer granted_paid_leave_days, Integer remaining_paid_leave_days, Date paidLeave_date) {
		super();
		this.id = id;
		this.code = code;
